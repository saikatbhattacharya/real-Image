...
# DEVELOPER'S NOTE
```
1. The CSV is converted to JSON and it is given here with
2. Lodash module is used 
3. It is a comman line interface tool 
4. The program does not check the duplicacy of distributor's name
5. With this program one can be able to create distributor, assign GEOs, create subdistributors and check the GEO if that is assigned to a particular distributor/sub-distributor 
```
